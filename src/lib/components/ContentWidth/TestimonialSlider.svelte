<script lang="ts">
  ...
  onMount(() => {
    if (testimonials.length > 0) testimonialArray = testimonials;
...
<ContentWidth class=" lg:h-[560px] relative">
            ...
            <div class="w-full lg:h-full flex flex-col justify-center gap-6 lg:gap-12 lg:p-12">
              ...
              <div class="flex gap-9 items-center">
                <img
                  ...
                  alt={testimonial.profileImage}
                  class="h-16 w-16 rounded-full bg-light"
                />
  ...
  <button
    class="hidden lg:block absolute top-1/2 -translate-y-1/2 -left-6 -translate-x-full"
    onclick={slideRight}
